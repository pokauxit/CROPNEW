...
CREATE TABLE `ageiculturist` (
  ...
  `home_no` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'บ้านเลขที่',
  `phone_no` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'หมายเลขโทรศัพท์',
  `agriculturist_name` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อเกษตรกร',
  `tambon_id` int(11) NOT NULL COMMENT 'รหัสตำลบ'
...
--
-- Table structure for table `apply_fertilizer`
--

CREATE TABLE `apply_fertilizer` (
  `apply_fertilizer_id` int(11) NOT NULL COMMENT 'รหัสการให้ปุ๋ย',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='การให้ปุ๋ย';

--
-- Dumping data for table `apply_fertilizer`
--
...
CREATE TABLE `symptom` (
  `symptom_id` int(11) NOT NULL COMMENT 'รหัสอาการ',
  `symptom_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อของอาการ',
  `symptom_detail` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รายละเอียดของอาการ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tambon` (`tambon_id`, `tambon_code`, `tambon_name`, `amphur_id`, `province_id`, `geo_id`) VALUES
...
--
-- Indexes for table `apply_fertilizer`
--
ALTER TABLE `apply_fertilizer`
  ADD PRIMARY KEY (`apply_fertilizer_id`);
...
--
ALTER TABLE `symptom`
  MODIFY `symptom_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสอาการ', AUTO_INCREMENT=3;
--
