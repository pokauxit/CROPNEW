                        ...
                        <div class="row">
                            <div class="col s12">
                                <ul class="tabs maincrop">
                                    ...
                                    <li class="tab col s3"><a href="#">มาตฐาน</a></li>
                                    <li class="tab col s3"><a class="<?php if($active == "CropStandard"){echo "active";}?>" href="?CropStandard//<?php echo ID?>">ปัญหาและการควบคุม</a></li>
                                </ul>
                            </div>
