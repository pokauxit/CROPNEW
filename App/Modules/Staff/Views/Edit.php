        ...
        <form class="col s12" action="" method="post" onsubmit="return check(this)" >
            ...
            <div class="row  ">
                ...
                <div class="input-field col s12 m6">
                    <input name="staff_name" type="text" class="validate" required value="<?php echo $this->rowId->staff_name ?>">
                    <label for="staff_name">ชื่อ - สกุล</label>
                </div>
                <div class="input-field col s12 m6">
                    <input name="staff_user" type="text" class="validate" required value="<?php echo $this->rowId->staff_user ?>">
            ...
            <div class="row">
                ...
                <div class="col m8 s12 center">
                    ...
                    <button class="btn waves-effect orange"  style="margin: 5px;" type="button" onclick="window.location.href = '<?php echo $this->route->backToModule(); ?>'"><i class="fa fa-arrow-circle-left"></i> ย้อนกลับ </button>
