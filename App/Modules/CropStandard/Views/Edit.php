...
<form class="col s12" action="" method="post">
    ...
    <div class="row">
        <div class="input-field  col  s12 m6">
            <select name="sid">
                ...
                echo $Standard->getStandardAll($this->rowId->sid); // ส่ง ID ไป Selected
                ?>
            </select>
    ...
    <div class="row">
        <div class="input-field  col  s12 m6">
            ...
            <input name="start_year" type="text" class="validate" required value="<?php echo $this->rowId->start_year; ?>">
        </div>
        <div class="input-field col  s12 m6">
            <label for="end_year">ปีที่สิ้นสุด</label>
            <input name="end_year" type="text" class="validate" required value="<?php echo $this->rowId->end_year; ?>">
        </div>
    </div>
    ...
    <div class="row  ">
        <div class="input-field col s12 m12">
            ...
            <textarea name="remark" class="materialize-textarea" rows="1" style="height:20px;"><?php echo $this->rowId->remark; ?></textarea>
        </div>
    </div>
    <div align="center">
