        ...
        <form class="col s12" action="" method="post" onsubmit="return check(this)" >
            ...
            <div class="row  ">
                ...
                <div class="input-field col s12 m6">
                    <input name="soil_name" type="text" class="validate" required>
            ...
            <div class="row">
                <div class="input-field col  s12 m6">
                    <input name="soil_factor" type="text" class="validate" required>
                    <label for="soil_factor">จุดเด่นของดิน</label>
                </div>

                <div class="input-field col s12 m6">
                    <input name="soil_problem" type="text" class="validate" required>
                    <label for="soil_problem">ปัญหาของดิน</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col  s12 m6">
                    <input name="soil_nutrition" type="text" class="validate" required>
