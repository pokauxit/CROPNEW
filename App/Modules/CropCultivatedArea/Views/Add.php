...
<form class="col s12" action="" method="post">
    ...
    <div class="row">
        ...
        <div class="input-field col s12 m4">
            ...
            <input name="lat" type="text" class="validate" required>
        </div>
        <div class="input-field col s12 m4">
            <label for="long">ลองติจูด</label>
            <input name="long" type="text" class="validate" required>
        </div>
    </div>
    ...
    <div class="row">
        <div class="input-field col s12 m6">
            ...
            <input name="area_detail" type="text" class="validate" required>
        </div>
        <div class="input-field col s12 m6">
            <label for="soil_drainage">การระบายน้ำของดิน</label>
            <input name="soil_drainage" type="text" class="validate" required>
        </div>
    </div>
    <div align="center">
