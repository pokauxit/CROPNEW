        ...
        <table class="bordered  striped " style="min-width: 500px;"  >
            ...
            <?php while ($rc = $this->db->fetch()) : ?>
                <tr>
                    ...
                    <td>
                        <a  href="<?php echo $this->route->Edit($rc->symptom_id);?>"><i class="orange-text fa fa-edit"></i> แก้ไข</a>
                        | <a onclick="return confirm('ยืนยันการลบ')"  href="<?php echo $this->route->Delete($rc->symptom_id);?>""><i class="red-text fa fa-trash"></i> ลบ </a>
                    </td>
                </tr>
            <?php endwhile; ?>
            </tbody>
