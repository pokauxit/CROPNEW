...
<div class="container" id="container-center">
    ...
    <br/>
    <form class="center" name="form_edit_typefertilizer" id="form_insert_typeplant" method="post" action=""  onsubmit="return check(this)" >
        
        <div class="input-field col s12 m12 center">
            <input type="text" name="type_fertilizer_name" value="<?php echo $this->row->type_fertilizer_name;?>">
